...
public:
    static double getTargetFuelAirRatio(FLOAT64 ambientTemperature, FLOAT64 ambientPressure, double mixturePercentage) {
        double maxPowerManifoldPressure = 29.6;
        double criticalAltitude = 18000.0;
        double icaoStandardPressureAtCriticalAltitude = 14.95168;
        ...
        if (mixturePercentage == 100.0) {
            ...
            double targetFuelAirRatio = fullRichSpecificVolume * (fullRichSpecificVolumeConstant + (mixturePercentage - 100.0) * slope_90_100);
            return targetFuelAirRatio;
        }
        else if (mixturePercentage >= 75.0) {
            double targetFuelAirRatio = fullRichSpecificVolume * (fullRichSpecificVolumeConstant + (90.0 - 100.0) * slope_90_100 + (mixturePercentage - 90.0) * slope_75_90);
            return targetFuelAirRatio;
        }
        else if (mixturePercentage >= 60.0) {
            double targetFuelAirRatio = fullRichSpecificVolume * (fullRichSpecificVolumeConstant + (90.0 - 100.0) * slope_90_100 + (75.0 - 90.0) * slope_75_90 + (mixturePercentage - 75.0) * slope_60_75);
            return targetFuelAirRatio;
        }
        else if (mixturePercentage >= 20.0) {
            double targetFuelAirRatio = fullRichSpecificVolume * (fullRichSpecificVolumeConstant + (90.0 - 100.0) * slope_90_100 + (75.0 - 90.0) * slope_75_90 + (60.0 - 75.0) * slope_60_75 + (mixturePercentage - 60.0) * slope_20_60);
            return targetFuelAirRatio;
        }
        else {
            ...
            double targetFuelAirRatio = fullRichSpecificVolume * (fullRichSpecificVolumeConstant + (90.0 - 100.0) * slope_90_100 + (75.0 - 90.0) * slope_75_90 + (60.0 - 75.0) * slope_60_75 + (20.0 - 60.0) * slope_20_60 + (mixturePercentage - 20.0) * slope_0_20);
            return targetFuelAirRatio;
        }
    }
};
